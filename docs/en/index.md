...
> scripted-expert path on a reference R9700 all passed. The renumbered L12 training
> content is also `gpu-verified` after ACT and SmolVLA GPU smoke, checkpoint audit,
> and reload checks. The other 4 lessons remain `planned`.
